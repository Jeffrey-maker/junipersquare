! function(t, n, e) {
        ...
        if (t(20), h.features.err) {
            ...
            x.on("jserrors", function() {
                var t = u.take(["err", "ierr"]),
                    ...
                    e = w(h.releaseIds);
                return "{}" !== e && (n.qs.ri = e), t && t.err && t.err.length && !E && (n.qs.pve = "1", E = !0), n
    ...
    32: [function(t, n, e) {
        ...
        function i() {
            this.resolved || (this.resolved = !0, this[F] = nt)
        }
        ...
        function a(t) {
            ot || t || !it || (t = it.root), nt && nt[O].checkFinish(), et = nt, nt = t && !t[O].root.end ? t : null
        }

        function s(t, n) {
            this.eventName = t, this.id = ut++, this.nodes = 0, this[P] = 0, this.finishTimer = null, this.lastCb = this.lastFinish = n, this.handlers = [];
            var e = this.root = new u(this, null, "interaction", n),
                r = e.attrs;
            r.trigger = t, r.initialPageURL = m.origin, r.oldRoute = Y, r.newURL = r.oldURL = Q, r.custom = {}, r.store = {}
        }

        function u(t, n, e, r) {
            this[O] = t, this.parent = n, this.id = ut++, this.type = e, this.children = [], this.end = null, this.jsEnd = this.start = r, this.jsTime = 0, this.attrs = {}
        }
        ...
        function f(t) {
            return t.ignored || !t.save && !t.routeChange ? void v.emit("interactionDiscarded", [t]) : (t.root.attrs.id = A.generateUuid(), "initialPageLoad" === t.root.attrs.trigger && (t.root.attrs.firstPaint = C["first-paint"], t.root.attrs.firstContentfulPaint = C["first-contentful-paint"]), v.emit("interactionSaved", [t]), lt = p(t.root, 0, N, t.routeChange), void h.sendX("events", m))
        }
        var d = t(17),
            l = t(36),
            h = t(9),
        ...
        n.exports = function() {
            ...
            function t() {
                st++, this.prevNode = nt, this.ct = at, at = 0, tt = _
            }
            ...
            function n() {
                ...
                var t = this.jsTime || 0,
                    n = t - at;
                at = this.ct + t, nt && (nt.callback(n, this[M]), this.isTraced && (nt.attrs.tracedTime = n)), this.jsTime = nt ? 0 : n, a(this.prevNode), this.prevNode = null, tt = _
            }
            ...
            function e(t, n, e) {
                ...
                if (r) {
                    var i = r[O],
                        o = this.inc;
                    this.isTraced = !0, o ? i[P]-- : r && r.finish(t), e ? a(r) : i.checkFinish()
                }
            }

            function u(t) {
                return nt && nt[O] === t ? nt : t.root
            }
            it = new s("initialPageLoad", 0), it.save = !0, nt = it.root, it[P]++, d.on(v, I, t), d.on(x, q, t);
            var f = {
                getCurrentNode: o,
                setCurrentNode: a
            };
            d("spa-register", function(t) {
            ...
            }), d.on(v, M, n), d.on(x, "cb-end", n), d.on(w, I, function(t, n) {
                var e = t[0],
                    r = e.type,
                    i = e.__nrNode;
                if (ot || "load" !== r || n !== window || (ot = !0, this.prevNode = nt = null, it && (i = it.root, it[P]--, W(function() {
                        U.push("popstate")
                    }))), i) a(i);
                else if ("hashchange" === r) a(rt), rt = null;
                else if (n instanceof XMLHttpRequest) a(v.context(n).spaNode);
                else if (!nt && U.indexOf(r) !== -1) {
                    var o = new s(r, this[I]);
                    if (a(o.root), "click" === r) {
                        var u = c(e.target);
                ...
                !nt || tt - this.timerDuration < 0 || (nt[O][P]++, this.timerId = e, Z[e] = nt, this.timerBudget = tt - 50)
            }), d.on(b, "clearTimeout-start", function(t) {
                var n = t[0],
                    e = Z[n];
                if (e) {
                    var r = e[O];
                    r[P]--, r.checkFinish(), delete Z[n]
                }
            }), d.on(b, I, function() {
                tt = this.timerBudget || _;
                var t = this.timerId,
                    n = Z[t];
                a(n), delete Z[t], n && n[O][P]--
            }), d.on(T, I, function() {
                a(this[F])
            }), d.on(T, "new-xhr", function() {
                nt && (this[F] = nt.child("ajax", null, null, !0))
            }), d.on(T, "send-xhr-start", function() {
                var t = this[F];
                t && !this.sent && (this.sent = !0, t.dt = this.dt, t.jsEnd = t.start = this["send-xhr-start"], t[O][P]++)
                ...
                if (nt) {
                    var n = this[H] = nt.child("ajax", this[z]);
                ...
                var t = this[H];
                if (t) {
                    if (null === this.status) return t[O][P]--, void(t.cancelled = !0);
                    var n = t.attrs,
                        e = n.params = {},
                        r = l(this.url);
                    e.method = "GET", e.pathname = r.pathname, e.host = r.hostname + ":" + r.port, e.status = this.status, n.metrics = {
                        txSize: 0,
                        rxSize: 0
                    }, n.isJSONP = !0, t.jsEnd = this[X], t.jsTime = this[q] ? this[X] - this[q] : 0, t.finish(t.jsEnd)
                }
            }), d.on(j, z, function(t, n) {
                nt && t && (this[F] = nt.child("ajax", this[z]), t.length >= 1 && (this.target = t[0]), t.length >= 2 && (this.opts = t[1]), n && this[F] && (this[F].dt = n))
            }), d.on(j, D + "start", function(t) {
                nt && (this[F] = nt, nt[O][P]++)
            }), d.on(j, D + "end", function(t, n, e) {
                var r = this[F];
                r && r[O][P]--
            }), d.on(j, $, function(t, n) {
                var e = this[F],
                    ...
                    i = this.opts || {};
                if (e) {
                    if (t) return e.cancelled = !0, void e[O][P]--;
                    var o, a;
                    "string" == typeof r ? o = r : "object" == typeof r && r instanceof K && (o = r.url), a = ("" + (r && r.method || i.method || "GET")).toUpperCase();
                    var s = e.attrs,
                        u = s.params = {},
                        c = l(o);
                    u.method = a, u.pathname = c.pathname, u.host = c.hostname + ":" + c.port, u.status = n.status, s.metrics = {
                        txSize: R(i.body) || 0,
                        rxSize: this.rxSize
                    }, s.isFetch = !0, e.finish(this[$])
                }
            }), d.on(y, "newURL", function(t, n) {
                nt && (Q !== t && (nt[O].routeChange = !0), n && (rt = nt)), Q = t
                ...
                if (nt) {
                    var r = t[0],
                        ...
                        o = nt.interaction;
                    i && (o[P]++, r.addEventListener("load", n, !1), r.addEventListener("error", e, !1))
                }
            }), d.on(g, I, function() {
                a(et)
            }), d.on(x, "resolve-start", i), d.on(x, "executor-err", i), d.on(x, "propagate", r), d.on(x, q, function() {
                var t = this.getCtx ? this.getCtx() : this;
                a(t[F])
            }), d(B + "get", function(t) {
                var n = this.ixn = nt ? nt[O] : new s("api", t);
                nt || (n.checkFinish(), st && a(n.root))
                ...
                var r = this.ixn,
                    i = u(r),
                    o = v.context(e);
                return n ? void(o[F] = i.child("customTracer", t, n)) : (o.inc = ++r[P], o[F] = i)
            }), d.on(E, I, e), d.on(E, "no-" + I, e), d(B + "getContext", function(t, n) {
        ...
        ft.checkFinish = function() {
            var t = this,
                n = this.root.attrs;
            t.finishTimer && (G(t.finishTimer), t.finishTimer = null), t[P] || (n.newURL = Q, n.newRoute = Y, t.finishTimer = W(function() {
                t.finishTimer = W(function() {
                    t.finishTimer = null, t[P] || t.finish()
                }, 1)
            }, 0))
        }, ft.finish = function() {
            var t = this,
            ...
            if (!n.end) {
                ...
                var e = Math.max(t.lastCb, t.lastFinish),
                    r = n.attrs,
                    i = r.custom;
                nt = n, S(this.handlers, function(t, n) {
                    n(r.store)
                }), a(null), S(m.info.jsAttributes, function(t, n) {
                    t in i || (i[t] = n)
                }), n.end = e, v.emit("interaction", [this]), ct.indexOf(this) >= 0 && ct.splice(ct.indexOf(this), 1)
            }
        };
        var dt = u.prototype;
        dt.child = function(t, n, e, r) {
            ...
            i.finishTimer && (G(i.finishTimer), i.finishTimer = null);
            var o = new u(i, this, t, n);
            return o.attrs.name = e, i.nodes++, r || i[P]++, o
        }, dt.callback = function(t, n) {
            var e = this;
            e.jsTime += t, n > e.jsEnd && (e.jsEnd = n, e[O].lastCb = n)
        ...
        h.on("events", function() {
            ...
            nt && (e._interactionId = nt.interaction.id, nt.type && "interaction" !== nt.type && (e._interactionNodeId = nt.id))
        }), v.on("interaction", f)
    }, {}],
    33: [function(t, n, e) {
        function r(t, n, e, r) {
            function d(t, c) {
                ...
                var g = t.type,
                    ...
                    N = E.params,
                    R = o.info.queueTime,
                    A = o.info.applicationTime;
                "undefined" == typeof h ? (y += n, h = y) : y -= h;
                var C = [u(y), u(t.end - t.start), u(t.jsEnd - t.end), u(t.jsTime)];
                switch (x) {
                    case 1:
                        C[2] = u(t.jsEnd - h), C.push(l(E.trigger), l(i(E.initialPageURL, v)), l(i(E.oldURL, v)), l(i(E.newURL, v)), l(E.customName), p ? "" : r ? 1 : 2, s(p && R, u, !0) + s(p && A, u, !0) + s(E.oldRoute, l, !0) + s(E.newRoute, l, !0) + l(E.id), l(t.id), s(E.firstPaint, u, !0) + s(E.firstContentfulPaint, u, !1));
                        var U = f(E.custom, l);
                        T = T.concat(U), b = U.length, j && (w++, T.push("a," + l(j)));
                        break;
                    case 2:
                        C.push(l(N.method), u(N.status), l(N.host), l(N.pathname), u(S.txSize), u(S.rxSize), E.isFetch ? 1 : E.isJSONP ? 2 : "", l(t.id), s(t.dt && t.dt.spanId, l, !0) + s(t.dt && t.dt.traceId, l, !0) + s(t.dt && t.dt.timestamp, u, !1));
                        break;
                    case 4:
                        var L = E.tracedTime;
                        C.push(l(E.name), s(L, u, !0) + l(t.id))
                }
                for (var _ = 0; _ < t.children.length; _++) d(t.children[_], T);
                if (C.unshift(u(x), u(w += b)), c.push(C), w && c.push(T.join(";")), k) {
                    var I = ",",
                        M = "b",
                        q = 0;
                    a(e.slice(1, 21), function(t, n) {
                        void 0 !== n ? (M += I + u(n - q), I = ",", q = n) : (M += I + "!", I = "")
                    }), c.push(M)
                } else 1 === x && c.push("");
                return c
            }
