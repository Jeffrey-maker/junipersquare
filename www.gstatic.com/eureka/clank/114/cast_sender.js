    ...
    */
            ...
            return a.replace(Ra, function(d, e) {
                ...
                if (!g) {
                    ...
                    g = (e = x) ? e.createHTML(g) :
                        g;
                    g = new D(g, Ma);
                    if (c.tagName && Pa[c.tagName.toUpperCase()]) throw Error("goog.dom.safe.setInnerHtml cannot be used to set content of " + c.tagName + ".");
                    if (Qa())
    ...
    var K = function(a, b) {
        ...
        if (1 < c) {
            ...
            if (a instanceof K)
                for (c = db(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
            else
    ...
    R.prototype.resume = function() {
        this.j--;
        this.j || !this.h || this.g || (this.h = !1, xb(this))
    };
    var xb = function(a) {
        a.g = wb(function() {
            a.g = null;
    ...
    var V = function() {
        ...
        W = function(a, b, c, d) {
            ...
            d = ib(a.A, b);
            c && d && (a =
                hb(a.K, b.sequenceNumber)) && (b = new chrome.cast.Error(chrome.cast.C.INVALID_PARAMETER, d), (a = a.g) && a(b))
        };
    ...
    var Y = function(a, b, c) {
        ...
        Gb = function(a) {
            var b = Z;
            Eb.has(a.type) && b.ja && (b.m ? (a.sessionId = b.m, Fb(b, null, a.type, a, function() {}, function() {})) : b.Va.A(X(b, void 0, "urn:x-cast:com.google.cast.media",
                a)))
        };
    ...
    V.prototype.requestSession = function(a, b, c) {
        var d = this;
        this.j ? Cb(b) : (c = X(this, c), this.j = a, (new PresentationRequest(c)).start().then(function(e) {
            Y(d, e, b)
        }).catch(function(e) {
            d.j = null;
    ...
    var X = function(a, b, c, d) {
        ...
        var k = b.dialRequest;
        k && (e = k.appName, (g = k.launchParameter) && !g.match(Hb) && (g = Ab(g)));
        var l = [];
        l.push({
            appId: b.appId,
    ...
    var Db = function(a, b) {
        if (a.m) {
            ...
            ob(a.H, c, b) && (a.u.delete(c), a.I.delete(c), b = a.B.get(c)) && (a.B.delete(c), G(b.s(), function(e) {
                e(d)
            }))
        }
    };
    V.prototype.onMessage = function(a) {
        ...
        if (b = hb(this.K, a.sequenceNumber)) "error" == a.type ? (b = b.g) && b(a.message) : (b = b.j) && b(a.message);
